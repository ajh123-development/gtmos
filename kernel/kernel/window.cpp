...
void WindowDraw(Window window) {
    if (window.active == 1) {
        ...
        Buffer_SetTextColor(WINDOW_BORDER_TITLE_ACTIVE);
    }
    if (window.active == 0) {
        Buffer_FillRect(WINDOW_BORDER_OUTLINE, window.winX-4, window.winY-4, window.winW+8, window.winH+8);
        Buffer_FillRect(WINDOW_BORDER_INACTIVE, window.winX-3, window.winY-3, window.winW+6, window.winH+6);
        Buffer_FillRect(WINDOW_BORDER_OUTLINE, window.winX, window.winY, window.winW, window.winH);
        Buffer_FillRect(WINDOW_FILL, window.winX+1, window.winY+1, window.winW-2, window.winH-2);
